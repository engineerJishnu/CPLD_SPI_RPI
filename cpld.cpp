...
// (a) serial clock (CLK), 
// (b) Master Input Slave Output (MISO), 
// (c) Master Output Slave Input (MOSI) and 
// (d) Chip Select (CS).
...
// Only the selected device has the Chip Select line set low, while all other devices have their CS lines set high. 
...
// MOSI    P1-19
// MISO    P1-21
// SCLK    P1-23   P1-24    CE0 ---> CPLD
// GND     P1-25   P1-26    CE1 ---> NA
